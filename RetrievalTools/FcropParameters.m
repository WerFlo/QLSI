% Parameters to handle the Fourier transformed interferograms and to crop
% the side-band peaks in the Fourier space for filtering.

% This parameter class is taken from
